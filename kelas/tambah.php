...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $check = mysqli_query($conn, "SELECT id FROM kelas WHERE nama_kelas = '$nama_kelas' AND tingkat = '$tingkat'");
    if(mysqli_num_rows($check) > 0) {
        $error = "Kelas dengan nama dan tingkat yang sama sudah ada!";
    } else {
        $query = "INSERT INTO kelas (nama_kelas, tingkat, jurusan, wali_kelas, keterangan) 
                 VALUES ('$nama_kelas', '$tingkat', '$jurusan', '$wali_kelas', '$keterangan')";
                ...
                <form method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="jurusan" list="jurusanList" required>
